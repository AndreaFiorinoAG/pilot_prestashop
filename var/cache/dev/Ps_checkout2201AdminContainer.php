...
class Ps_checkout2201AdminContainer extends Container
{
    ...
    {
        return $this->services['ps_checkout.cache.directory'] = new \PrestaShop\ModuleLibCacheDirectoryProvider\Cache\CacheDirectoryProvider('1.7.8.7', 'C:\\wamp64\\www\\prestashop_prod', true);
    }
